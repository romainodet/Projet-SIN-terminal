...
<html>
<head>
<?php $titre_page="Connexion"; include('assets/php/header.php'); ?>
<style>body{
...
if (isset($_REQUEST['email'])){
	...
	//Checking is user existing in the database or not
        $query = "SELECT * FROM `users` WHERE email='$email' AND pass='$password' AND categorie_users='1'";
...
<input type="email" name="email" placeholder="E-mail" required onFocus="field_focus(this, 'email');" onblur="field_blur(this, 'email');" class="email" />
